...
<html lang="en">
<head>
    <title>Code coverage report for src/commands/stat-artifacts.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/commands</a> stat-artifacts.ts
    </h1>
    <div class='clearfix'>
...
export const handler = async (args: Args): Promise&lt;{ artifacts: Map&lt;string, Stat&gt; }&gt; =&gt; {
  const { artifacts: artifactGlobs, baseDir, cwd, getFilenameHash, nameMapper = defaultNameMapper<span class="branch-1 cbranch-no" title="branch not covered" > } = a</span>wait getConfig(
    args.config
  );
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Mar 14 2019 11:58:38 GMT-0700 (Pacific Daylight Time)
</div>
</div>
