...
<html lang="en">
<head>
    <title>Code coverage report for src/commands/create-build.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/commands</a> create-build.ts
    </h1>
    <div class='clearfix'>
...
export const handler = async (args: Args): Promise&lt;{}&gt; =&gt; {
  ...
  if (isDirty) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Current work tree is dirty. Please commit all changes before proceeding');</span>
  }
&nbsp;
